	...
	<body>
		...
		<div id="total" class="container_16">
			...
			<div id="conteudo" class="grid_12">
                            ...
                            <h2>Devolução do Livro</h2>
                            <form method="post">
                            <h4>Titulo a ser Devolvido: 
                            <input type="text" name="txtTitulo" size="15" ><br><br>

                            <input type="submit" name="btnDevolucao" value="Devolução">
                            </form>
                            <?php
                            if(isset($_POST["txtTitulo"])){
                                ...
                                if($result){
                                    ...
                                    echo "<br>ERRO --- result --- " . mysqli_error($connect);
                                }
                                ...
                                $resultIf = mysqli_query($connect,$sqlIf);
                                    if($resultIf && mysqli_num_rows($resultIf) >= 0){
                                        ...
                                        if($quantidade_dispo < $quantidade){
                                            ...
                                            $resultReplace = mysqli_query($connect,$sqlReplace);
                                                if($resultReplace){
                                                    echo "<br>Devolução efetuada com sucesso!!<br>";
                                                }else{
